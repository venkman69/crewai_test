...
def job_analysis_and_decision_crew(
    ...
    """
    Analyze the job and resume and return the job analysis and decision
    Args:
        job_url: str
        resume_output: CrewOutput
        get_from_cache: bool
    Returns:
...
if __name__ == "__main__":
    ...
    if Path(default_resume).exists():
        ...
        resume = f"{resume_storage_dir}/{resumes[0]}"
